...
namespace MatchingGame
{
    public partial class Form1 : Form
    {
        ...
        //Use this Random object to choose randomicons for the squares
        Random random = new Random();

        //Each of these letteres is an interesting icon in the Webdings font and each icon appears twice in this list
        ...
        private void label1_Click_1(object sender, EventArgs e)
        {
            ...
            if (clickedLabel != null)
            {
                ...
                // If the player gets this far, the player clicked two different icons,
